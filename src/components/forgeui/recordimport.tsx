...
function ExcelIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 486 500" className={className} aria-hidden="true">
      <defs>
        <radialGradient
          id="rimRadial0"
        ...
        >
          <stop
            offset="0.06"
            stopColor="rgb(21.568627%,58.431373%,22.352941%)"
          />
          <stop
            offset="0.42"
            stopColor="rgb(16.078431%,48.627451%,17.647059%)"
          />
          <stop offset="0.7" stopColor="rgb(8.235294%,33.72549%,10.980392%)" />
        </radialGradient>
        <radialGradient
          id="rimRadial1"
          gradientUnits="userSpaceOnUse"
        ...
        >
          <stop
            offset="0"
            stopColor="rgb(2.745098%,23.137255%,6.27451%)"
            stopOpacity="0.698039"
          />
          <stop
            offset="0.99"
            stopColor="rgb(3.137255%,29.019608%,7.45098%)"
            stopOpacity="0"
          />
        </radialGradient>
        <linearGradient
        ...
        >
          <stop offset="0" stopColor="rgb(32.156863%,81.960784%,48.627451%)" />
          <stop
            offset="0.33"
            stopColor="rgb(29.019608%,65.098039%,27.843137%)"
          />
        </linearGradient>
        <linearGradient
          id="rimLinear1"
        ...
        <linearGradient
          ...
          gradientTransform="matrix(1,0,0,-1,0,502)"
        >
          <stop offset="0" stopColor="rgb(40%,81.568627%,32.156863%)" />
          <stop offset="1" stopColor="rgb(52.156863%,91.372549%,44.705882%)" />
        </linearGradient>
        <radialGradient
          id="rimRadial2"
          gradientUnits="userSpaceOnUse"
        ...
        >
          <stop
            offset="0.29"
            stopColor="rgb(30.588235%,70.588235%,23.137255%)"
          />
          <stop
            offset="1"
            stopColor="rgb(44.705882%,80%,38.039216%)"
            stopOpacity="0"
          />
        </radialGradient>
        <linearGradient
        ...
        >
          <stop
            offset="0.18"
            stopColor="rgb(75.294118%,87.843137%,45.882353%)"
            stopOpacity="0"
          />
          <stop offset="1" stopColor="rgb(81.960784%,92.156863%,58.431373%)" />
        </linearGradient>
        <radialGradient
          id="rimRadial3"
          gradientUnits="userSpaceOnUse"
        ...
        >
          <stop
            offset="0.44"
            stopColor="rgb(47.45098%,91.372549%,42.745098%)"
          />
          <stop offset="1" stopColor="rgb(81.568627%,92.156863%,46.27451%)" />
        </radialGradient>
        <radialGradient
          id="rimRadial4"
          gradientUnits="userSpaceOnUse"
        ...
        >
          <stop offset="0" stopColor="rgb(12.54902%,65.882353%,36.862745%)" />
          <stop
            offset="0.94"
            stopColor="rgb(3.529412%,26.666667%,16.470588%)"
          />
        </radialGradient>
        <radialGradient
          id="rimRadial5"
        ...
        >
          <stop
            offset="0.58"
            stopColor="rgb(20%,65.098039%,38.431373%)"
            stopOpacity="0"
          />
          <stop
            offset="0.97"
...
const CARD =
  "bg-linear-to-b from-neutral-100/60 to-white shadow-[inset_0_0_0_1px_rgba(0,0,0,0.1),inset_0_2.5px_0_0_rgba(255,255,255,1)] dark:from-[#1c1c1c] dark:to-[#141414] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.08),inset_0_0_0_1px_rgba(255,255,255,0.06),0_24px_48px_-26px_rgba(0,0,0,0.85)]";
...
const RecordImport = () => {
  return (
    <FitScale width={480} height={280}>
      <div className="relative h-full w-full">
        <div
          className="absolute top-44 flex size-24 -translate-y-1/2 items-center justify-center"
          style={{ left: 40 }}
        >
          <ExcelIcon className="size-14" />
        </div>

        <ArrowIcon className="absolute top-1/2 left-32 size-9 -translate-y-1/2 text-neutral-300 dark:text-neutral-600" />
        ...
        >
          <div className="flex items-center gap-3 px-5 pt-4">
            <Image
              ...
              width={44}
              height={44}
              className="size-11 shrink-0 rounded-full object-cover ring-1 ring-black/10 dark:ring-white/10"
            />
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute bottom-0 z-10 h-24 bg-[linear-gradient(to_top,var(--color-white),transparent)] dark:bg-[linear-gradient(to_top,var(--color-black),transparent)]"
