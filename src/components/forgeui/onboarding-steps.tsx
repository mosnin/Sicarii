...
const OnboardSteps = ({
  ...
  step2 = "Setting Up Your Profile",
  step3 = "Personalizing Your Preferences",
  step4 = "Accessing Your Dashboard",
}: {
  step1?: string;
  step2?: string;
  step3?: string;
...
const ContainerMask = () => {
  return (
    <>
      <div className="absolute bottom-0 left-0 h-22.5 w-full bg-[linear-gradient(to_top,var(--color-white)_40%,transparent_100%)] dark:bg-[linear-gradient(to_top,#000000_40%,transparent_100%)]" />
      <div className="absolute top-0 left-0 h-22.5 w-full bg-[linear-gradient(to_bottom,var(--color-white)_40%,transparent_100%)] dark:bg-[linear-gradient(to_bottom,#000000_40%,transparent_100%)]" />
    </>
  );
};
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "border border-[#dcdcdc] dark:border-neutral-800",
        "absolute inset-x-0 mx-auto flex h-12 w-[90%] max-w-62.5 gap-1.5",
        "bg-linear-to-br from-neutral-200 to-neutral-50 dark:from-neutral-800 dark:to-neutral-950",
        className,
      )}
    >
      <div className="relative h-[30.4px] w-3.5">
        ...
        <span
          ref={loaderRef}
          className="absolute inset-x-0 top-0.75 text-neutral-800 opacity-100 dark:text-neutral-100"
        >
          <LuLoader size={13} />
        </span>
      </div>
      ...
      <div className="flex w-full flex-col justify-between gap-2">
        <p>{title}</p>
        <div className="flex h-1.5 w-[90%] rounded-sm bg-[#dcdcdc] dark:bg-neutral-700">
          <span
            ref={progressRef}
