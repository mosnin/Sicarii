          ...
          <div className="mx-auto max-w-3xl px-4 prose prose-invert prose-sm">
            <div className="space-y-8 text-muted-foreground text-sm leading-relaxed">
              ...
              <div>
                ...
                <p>You have the right to access, correct, or delete your personal data. You may also request a copy of your data or opt out of non-essential communications. Contact us at hello@sicarii.agency for any privacy-related requests.</p>
              </div>

              <div>
                <h2 className="text-lg font-semibold text-foreground">7. Contact</h2>
                <p>For questions about this privacy policy, contact us at hello@sicarii.agency.</p>
              </div>
            </div>
          </div>
        </section>
