...
| `decisions/0015-agent-mailboxes.md` | Agent mailboxes: bought/brought sending domains (Porkbun, GoDaddy), AgentMail API inboxes + imported Google/Microsoft inboxes, own warmup engine, inbound classification, do-not-contact, metered `send_email` with cold-email lint, `/mailboxes`; Bird.com killed for outreach | Revisiting outreach / mailboxes / deliverability |
