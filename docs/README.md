...
| `decisions/0015-admin-workspaces-lists.md` | Admin desk, CRM lists/segments on the CRM page, Scalar-native workspaces (`ws_`) with plan caps; admins unlimited | Revisiting admin / lists / workspaces |
